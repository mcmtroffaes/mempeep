...
static_assert(mempeep::IsPrimitive<unsigned char>);
static_assert(mempeep::IsPrimitive<unsigned short>);
static_assert(mempeep::IsPrimitive<unsigned int>);
static_assert(mempeep::IsPrimitive<unsigned long>);
static_assert(mempeep::IsPrimitive<unsigned long long>);
